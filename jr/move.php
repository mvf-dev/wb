...
$name="jr_staging_".date('m-d-Y-His').".txt";
$myFile = "/mnt/fs4_wb_netflix_automation/06-for-delivery/".$name;
...
fclose($fh);
//$cmd="php /home/kevin/jr_staging.php ".$name." > /dev/null &";
//$ssh->exec($cmd);
$query=mysql_query("INSERT into `jobs_queue`(`job_type`,`file_name`,`date_submit`) values ('jr','$name', '$timeNow')") or die(mysql_error());
mysql_close();
//$ssh->exec('logout');
//$ssh->disconnect();
?>
