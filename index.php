...
<![endif]-->
<title>Netflix Files Search</title>
...
if(isset($_POST['query'])) {
	...
	$i=0;
	 ...
	 echo "<tr><th>File Name</th><th>Arrival Date</th><th>Language</th></tr>";
        $query=mysql_query("SELECT file_name, arrival_date from `netflix_files` where file_name like '$str' and file_name not like '%.mxf' order by file_name") or die(mysql_error());
