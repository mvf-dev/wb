<html>
<meta http-equiv="refresh" content="9;url=http://dm-mediainfo-2/battle/job.php">
...
if(isset($_POST['submit'])) {
	...
	$jobName=$_POST['job'];
	$name="netflix_copy_".date('m-d-Y-His').".txt";
					...
					if(($row['frame_rate']=="23.976")&&($row['scan_type']=="Progressive")) {
						if($row['aspect_ratio']=="16:9") {
							if($row['audio_channel']=="2") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_82_Netflix_Proxy_p2398_16x9_2ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}

							else if($row['audio_channel']=="8") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_83_Netflix_Proxy_p2398_16x9_8ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}
							...
							if($row['audio_channel']=="2") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_90_Netflix_Proxy_p2398_4x3_2ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}
							
							else if($row['audio_channel']=="8") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_91_Netflix_Proxy_p2398_4x3_8ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}
						}
					}
						...
						if($row['aspect_ratio']=="16:9") {
							if($row['audio_channel']=="2") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_84_Netflix_Proxy_i2997_16x9_2ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}

							else if($row['audio_channel']=="8") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_85_Netflix_Proxy_i2997_16x9_8ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}
							...
							if($row['audio_channel']=="2") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_92_Netflix_Proxy_2997_4x3_2ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}
						
							else if($row['audio_channel']=="8") {
								$cmd="sed 's|Input_File_Pathname|$file|\n s|SDI_Proxy_Directory_Name|$sdi_proxy|\n s|QC_Proxy_Directory_Name|$sdi_proxy|' jobs_xml/Job_Profile_93_Netflix_Proxy_2997_4x3_8ch.xml |\\\n curl --header 'Accept: application/xml' --header 'Content-type: application/xml' --data @- http://172.25.137.31/api/v2.4.1/jobs";
								$output=shell_exec($cmd);
							}
...
$query=mysql_query("INSERT into `jobs_queue`(`job_name`,`file_name`,`priority`,`date_submit`,`action_id`) values ('$jobName','$name', '$priority', '$date','1')") or die(mysql_error());
